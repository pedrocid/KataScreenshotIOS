...
class SuperHeroesViewControllerTests: ScreenshotTest {
    ...
    func testShows3SuperHeroesCase() {
        _ = givenThereAreSomeSuperHeroes(3, avengers: false)
    ...
    func testShows10SuperHeroesCase() {
    ...
    func testShowsAvengersBadgeSuperHeroesCase() {
